CREATE TABLE IF NOT EXISTS rw_ext_anp.contratos_cessao_espaco_carregamento (
    ...
    volume_m3 STRING OPTIONS(description="Volume total autorizado no contrato em metros cúbicos"),
    gasolina_a STRING OPTIONS(description="Quantidade destinada a Gasolina A"),
    gasolina_a_premium STRING OPTIONS(description="Quantidade destinada a Gasolina A - Premium"),
    ...
    oleo_diesel_b_s10 STRING OPTIONS(description="Quantidade destinada a Óleo Diesel B S10"),
    diesel_c_s10 STRING OPTIONS(description="Quantidade destinada a Diesel C S10"),
    oleo_diesel_mar STRING OPTIONS(description="Quantidade destinada a Óleo Diesel Mar"),
    oleo_combustivel_1a STRING OPTIONS(description="Quantidade destinada a Óleo Combustível - 1A"),
    oleo_combustivel_1b STRING OPTIONS(description="Quantidade destinada a Óleo Combustível - 1B"),
