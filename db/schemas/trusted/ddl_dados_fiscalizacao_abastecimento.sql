CREATE TABLE IF NOT EXISTS td_ext_anp.dados_fiscalizacao_do_abastecimento (
    ...
    data_do_df DATE OPTIONS(description="Data do Documento de Fiscalização (DF)."),
    numero_do_documento NUMERIC OPTIONS(description="Nº do Documento de Fiscalização utilizado pela autoridade competente da ANP ou do órgão público conveniado designado para as atividades de fiscalização."),
