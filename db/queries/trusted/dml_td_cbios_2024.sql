MERGE td_ext_anp.cbios_2024 AS target
USING (
SELECT
	...
	SAFE_CAST (meta_definitiva_2024 AS NUMERIC) AS meta_definitiva_2024,
    data_criacao
FROM
    rw_ext_anp.cbios_2024
WHERE
    data_criacao = (SELECT MAX(data_criacao) FROM rw_ext_anp.cbios_2024)
) AS source
...
UPDATE SET
    ...
    target.meta_definitiva_2024 = source.meta_definitiva_2024,
