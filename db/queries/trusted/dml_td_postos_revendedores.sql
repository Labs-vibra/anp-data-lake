...
USING (
	SELECT
		...
		PARSE_DATE('%d/%m/%Y', TRIM(data_publicacao_dou_autorizacao)) AS data_publicacao_dou_autorizacao,
		...
		PARSE_DATE('%d/%m/%Y', TRIM(data_de_vinculacao_a_distribuidor)) AS data_de_vinculacao_a_distribuidor,
		...
		PARSE_DATE('%d/%m/%Y', TRIM(data_autorizacao_delivery)) AS data_autorizacao_delivery,
