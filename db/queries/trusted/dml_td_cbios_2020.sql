MERGE td_ext_anp.cbios_2020 AS target
USING (
SELECT
    razao_social,
	...
	SAFE_CAST (meta_individual_2020 AS NUMERIC) AS meta_individual_2020,
    data_criacao
FROM
    rw_ext_anp.cbios_2020
WHERE
    data_criacao = (SELECT MAX(data_criacao) FROM rw_ext_anp.cbios_2020)
) AS source
...
UPDATE SET
    ...
    target.meta_individual_2020 = source.meta_individual_2020,
