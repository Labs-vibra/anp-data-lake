...
def rw_ext_anp_liquidos_entrega_fornecedor_atual():
    """
    Faz download do arquivo de Market Share - Líquidos Entrega Fornecedor Atual do bucket no GCP,
    ...
    blobs_filtrados = [b for b in blobs if "LIQUIDOS_ENTREGAS_FORNECEDOR_ATUAL" in b.name]
    if not blobs_filtrados:
        raise FileNotFoundError("Nenhum arquivo encontrado com 'LIQUIDOS_ENTREGAS_FORNECEDOR_ATUAL' no nome.")
...
if __name__ == "__main__":
	rw_ext_anp_liquidos_entrega_fornecedor_atual()